...
class MessageRequestV1Spec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType(MessageRequestV1::class);
    }
    ...
    function it_should_be_constructed_from_an_ASN1_representation()
    {
        ...
        ))->shouldBeLike(new MessageRequestV1('foo', new GetRequest(new OidList())));
    }
}
