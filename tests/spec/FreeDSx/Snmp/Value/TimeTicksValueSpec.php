...
class TimeTicksValueSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType(TimeTicksValue::class);
    }
    ...
    {
        $this->toAsn1()->shouldBeLike(Asn1::application(3, Asn1::integer(9)));
    }

    function it_should_be_constructed_from_an_ASN1_representation()
    {
        $this::fromAsn1(Asn1::application(3, new IncompleteType("\x09")))->shouldBeLike(new TimeTicksValue(9));
    }
}
