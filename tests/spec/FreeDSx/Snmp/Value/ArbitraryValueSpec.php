...
class ArbitraryValueSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType(ArbitraryValue::class);
    }
    ...
    {
        $this->equals('foo', true)->shouldBeEqualTo(true);
        $this->equals('bar', false)->shouldBeEqualTo(false);
    }
    ...
    {
        $this->toAsn1()->shouldBeLike(Asn1::application(4, Asn1::octetString('foo')));
    }

    function it_should_be_constructed_from_an_ASN1_representation()
    {
        $this::fromAsn1(Asn1::application(4, new IncompleteType('foo')))->shouldBeLike(new ArbitraryValue('foo'));
    }
}
