...
class GetNextRequestSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType(GetNextRequest::class);
    }
    ...
    function it_should_be_constructed_from_an_ASN1_representation()
    {
        ...
        $pdu = Asn1::context(1, $pdu)->setIsConstructed(true);

        $this::fromAsn1($pdu)->shouldBeLike(new GetNextRequest(new OidList(new Oid('1.2.3'))));
    }
